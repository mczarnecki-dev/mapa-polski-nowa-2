...
# --- Styl CSS zmniejszający czcionki ---
st.markdown(
    """
    <style>
    /* Zmniejszenie czcionki w całej aplikacji */
    .stText, .stMarkdown, .stButton {
        font-size: 0.8rem;
    }
    h1 {
        font-size: 1.2rem;
    ...
    /* Zmniejszenie czcionki w panelu bocznym (jeśli używasz sidebar) */
    .css-1d391kg {
        font-size: 0.8rem;
    }
    </style>
...
if input_z and input_do and input_z != input_do:
    ...
    mapa = folium.Map(location=[srodek_lat, srodek_lon], zoom_start=7, width=1200, height=900)
